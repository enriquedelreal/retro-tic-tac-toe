...
class RetroSolitaire {
    ...
    initializeGame() {
        ...
        this.renderGame();
        this.startTimer();
        console.log('Solitaire: Game initialized');
    }
    ...
    showHint() {
        // Simple hint system - highlight a possible move
        this.updateStatus('Look for Aces to start foundations, or Kings for empty tableau spaces!');
    }
    ...
    newGame() {
        ...
        this.updateStats();
        this.startTimer();
        this.updateStatus('New game started! Good luck!');
    }
